...
class InventoryProducer:
    ...
    async def start(self):
        ...
        for attempt in range(1, 6):
            try:
                ...
                logger.info("InventoryProducer started")
                return
            except Exception as e:
                logger.warning(f"InventoryProducer start attempt {attempt}/5 failed ({e}), retrying in 2s...")
    ...
    async def stop(self):
        if self.producer:
            ...
            logger.info("InventoryProducer stopped")
